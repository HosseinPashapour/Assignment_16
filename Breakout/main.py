...
class Game(arcade.Window):
    def __init__(self):
        super().__init__(width=600, height=800, title='Breakout 2024', center_window=True)
        ...
        self.color = [arcade.color.GREEN, arcade.color.BARN_RED, arcade.color.BLUE,
                        arcade.color.DAFFODIL, arcade.color.AMARANTH_PURPLE
                        ]
    ...
    def game_over(self):
        ...
        self.background = arcade.load_texture('D:\Assignment_16\Breakout\game-over.jpg')
        print('💀 GAME OVER 💀')
    ...
    def on_draw(self):
        ...
        if self.life:
            ...
            for life in self.life:
                life.draw()
            arcade.draw_text(f'SCORE: {self.rocket.score}', 5, 780, arcade.color.BLUE, 15, 2,'left',('calibri', 'calibri'), True)
