...
class Game(arcade.Window):
    def __init__(self):
        super().__init__(width=800, height=500, title="🏓 Pong Game 🏓", center_window=True)
    ...
    def on_draw(self):
        ...
        self.player_2.draw()
        self.ball.draw()
        arcade.draw_text(f"score: {self.player_1.score}", 30, 30 ,arcade.color.RED, 20)
        arcade.draw_text(f"score: {self.player_2.score}", self.width - 130, 30 ,arcade.color.BLUE, 20)
